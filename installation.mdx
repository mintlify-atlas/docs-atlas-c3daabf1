  ...
  <Tab title="Local Files">
    ...
    <Steps>
      ...
      <Step title="Navigate to the Project">
        ...
        ```text
        AlgoritmosPlanificacion/Planificacion/
        ```
      </Step>
...
sudo cp -r AlgoritmosPlanificacion/Planificacion/* /var/www/html/
...
npx http-server AlgoritmosPlanificacion/Planificacion -p 8000
# Access at http://localhost:8000
```
</CodeGroup>
